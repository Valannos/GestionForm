...
public class FormationForm extends javax.swing.JDialog {
    ...
    public FormationForm(java.awt.Frame parent, boolean modal, FormationModel formModel, Formation toEditForm) {
        super(parent, modal);

        this.formModel = formModel;
        this.form = toEditForm;
        initComponents();
        jLabel_Title.setText("Mettre à jour une formation");
        formId = toEditForm.getId();
        jTextField_Formname.setText(toEditForm.getNom());
        jXDatePicker_StartingDate.setDate(toEditForm.getStart());
        jXDatePicker_EndingDate.setDate(toEditForm.getEnd());
    ...
    private void initComponents() {
        ...
        jTextField_Formname = new javax.swing.JTextField();
        ...
        jTextField_Formname.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField_FormnameActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextField_Formname, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextField_Formname, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel_FormName))
    ...
    private void jTextField_FormnameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_FormnameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField_FormnameActionPerformed
    ...
    private void jButton_FormFormation_OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_FormFormation_OKActionPerformed
        ...
        if (formId == 0) {
            ...
            form = new Formation(jTextField_Formname.getText(), jXDatePicker_StartingDate.getDate(), jXDatePicker_EndingDate.getDate());
            ...
            form = new Formation(jTextField_Formname.getText(), formId, jXDatePicker_StartingDate.getDate(), jXDatePicker_EndingDate.getDate());
            ...
            if (form.getNom() == null || form.getStart() == null || form.getEnd() == null) {
                ...
                FormationDAO.editFormation(form);
                JOptionPane.showMessageDialog(this, "Formation modifiée avec succès", "Formation", JOptionPane.INFORMATION_MESSAGE);
    ...
    private javax.swing.JTextField jTextField_Formname;
